...
public class ModificarEstablecimiento_Interactor implements ModificarEstablecimiento.Interactor {
    ...
    @Override
    public void performUpdateEstablismentLogo(final StorageReference Storage_Reference, final DatabaseReference Database_Reference,
                                              final String Url_Logo_Actual, final String ID_Establecimiento, final Uri Logo_Uri) {
    ...
    @Override
    public void performUpdateEstablismentDocument(StorageReference Storage_Reference, final DatabaseReference Database_Reference, final String Url_Document_Actual,
                                                  final String ID_Establecimiento, Uri Documento_Uri) {
