...
public class Resena_Modelo {
    ...
    public Resena_Modelo(String ID_Resena, String ID_Usuario_Cliente, String ID_Establecimiento, String descripcion, Double calificacion, String fecha) {
    ...
    public Resena_Modelo(String ID_Usuario_Cliente, String ID_Establecimiento, String descripcion, Double calificacion, String fecha) {
        this.ID_Usuario_Cliente = ID_Usuario_Cliente;
        this.ID_Establecimiento = ID_Establecimiento;
        Descripcion = descripcion;
        Calificacion = calificacion;
